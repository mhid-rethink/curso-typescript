...
// Template String
const userID = 'Matheus Dias';
const notifications = '9';
// const welcome: string = "Boas vindas " + userID + ". Notificações: " + notifications
const welcome = `Boas vindas ${userID}. Notificações: ${parseInt(notifications) > 9 ? '+9' : notifications}`;
// Desafios
// Exercicio 1
const double = (valor) => valor * 2;
console.log(double(10));
// Exercicio 2
const sayHiPerson = (name = 'Pessoa') => console.log(`Olá, ${name}`);
sayHiPerson();
sayHiPerson('Anna');
// Exercicio 3
